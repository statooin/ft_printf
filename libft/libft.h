...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/30 12:06:29 by statooin          #+#    #+#             */
/*   Updated: 2020/07/30 12:06:31 by statooin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_memexpand(void **src, size_t *size1,\
const void *add, size_t size2);
...
void			ft_striteri(char *string, void (*function)\
(unsigned int, char *));
